...
async function checkConnection() {
  try {
    ...
    return {
      ...
      consumerCount: chk.consumerCount,
    };
  } catch (e) {
    ...
    case "attraction-added": {
      ...
      return r.success
        ? {
            status: "processed",
            action: "added",
            message: `Dodana: ${r.item.name}`,
          }
        : {
            status: "error",
            action: "added",
            message: r.error || "Napaka pri dodajanju",
          };
    }
    case "attraction-updated": {
      ...
      return r.success
        ? {
            status: "processed",
            action: "updated",
            message: `Posodobljena: ${r.item.name}`,
          }
        : {
            status: "error",
            action: "updated",
            message: r.error || "Napaka pri posodabljanju",
          };
    }
    case "attraction-deleted": {
      ...
      return r.success
        ? {
            status: "processed",
            action: "deleted",
            message: `Izbrisana: ${r.item.name}`,
          }
        : {
            status: "error",
            action: "deleted",
            message: r.error || "Napaka pri brisanju",
          };
    }
    case "attraction-visited": {
      ...
      return r.success
        ? {
            status: "processed",
            action: "visited",
            message: `Obisk: ${r.item.name} (${r.item.visits})`,
          }
        : {
            status: "error",
            action: "visited",
            message: r.error || "Napaka pri obisku",
          };
    }
    default:
      return {
